...
Las "lightguns" fueron dispositivos creados para ampliar la interacción con los videojuegos, permitiendo una experiencia de disparo inmersiva en pantallas CRT al detectar de manera precisa la dirección en que el usuario apuntaba un periférico con forma de arma. Sin embargo, el principio de funcionamiento de las pantallas LED difiere del de las CRT, por lo que la tecnología de las "lightguns" no es directamente aplicable. Actualmente, existen algunos dispositivos que utilizan sensores de movimiento o cámaras externas para realizar tareas de detección de puntería, aunque estos suelen ser costosos o requieren configuraciones complejas. Frente a este panorama, el proyecto propone una solución más accesible y fácil de configurar, integrando el uso de smartphones y los sensores que ya poseen, lo que reduce la necesidad de hardware adicional.

Para el funcionamiento inicial del sistema, se propone desarrollar una aplicación para smartphone que ejecute la detección de la pantalla LED y procese la información de ubicación del punto de puntería. Los datos obtenidos serán enviados a una computadora con sistema operativo Windows, la cual interpretará esta información y permitirá controlar el movimiento del puntero del mouse en la pantalla de la PC. Adicionalmente, se implementarán funciones para realizar clic derecho e izquierdo mediante toques en la pantalla del teléfono, proporcionando una experiencia de interacción completa.
...
El proyecto se basa en el desarrollo de un sistema que combina la detección de objetos y el uso de sensores de movimiento. Los principales componentes y funcionalidades del sistema incluyen:
\begin{itemize}
...
\item Cálculo de posición relativa: Cuando el smartphone esté apuntando a la pantalla, se calculará la posición exacta donde el usuario está mirando dentro de la pantalla mediante proporcionalidad.
\item Envío de datos: La información de la ubicación del punto será enviada a una computadora mediante una conexión inalámbrica, pudiendo ser una conexión WiFi o Bluetooth. Los datos enviados serán recibidos por un software específico en el PC que moverá el puntero del mouse en la pantalla en la posición calculada.
\item Interacción adicional: Los sensores de movimiento del smartphone proporcionarán información adicional sobre la orientación del dispositivo para mejorar la precisión.
